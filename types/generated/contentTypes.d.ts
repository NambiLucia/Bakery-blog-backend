...
export interface ApiBlog1Blog1 extends Schema.CollectionType {
  collectionName: 'blog1s';
  info: {
    singularName: 'blog1';
    pluralName: 'blog1s';
    displayName: 'Blog1';
...
export interface ApiCupcakeCupcake extends Schema.CollectionType {
  ...
  info: {
    singularName: 'cupcake';
    pluralName: 'cupcakes';
    displayName: 'Cupcakerecipe';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    instructions: Attribute.String & Attribute.Required;
    frosting: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPastryPastry extends Schema.CollectionType {
